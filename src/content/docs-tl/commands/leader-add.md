---
title: LeaderAdd — Magdagdag ng Arrowhead Arm sa Umiiral na Multileader
description: Nagdaragdag ang LeaderAdd command ng bagong arrowhead arm sa umiiral na multileader. Ang bagong arm ay pareho ang dogleg, text, at lahat ng styling ng napiling leader. Dalawang click — piliin ang leader, ilagay ang bagong tip.
keywords: [CAD leader add arm, leaderadd command, magdagdag ng arrow sa leader, multileader arm, kulmanlab]
group: markup
order: 2
---
...
| [LeaderRemove](../leader-remove/) | Alisin ang isang arm mula sa multileader na may dalawa o higit pa |
