---
title: Align — Translate, Rotate, and Scale Entities Using Point Pairs
...
keywords: [CAD align command, align entities CAD, translate rotate scale, point pair alignment, kulmanlab]
group: edit
order: 6
---
