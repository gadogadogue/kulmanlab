---
title: Font Manager Command — Upload and Manage Custom TTF Fonts
...
1. Click **Add Font** in the dialog footer (or type [`FontAdd`](../font-add/) in the terminal to open the file picker directly).
