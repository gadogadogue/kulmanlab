...
配置されたマルチ引出線を**ダブルクリック**すると、**リッチ**モードでテキストエディターが再度開きます。リッチモードでは、太字・斜体・文字ごとのフォントや高さのオーバーライドを適用し、`Enter` で改行を挿入できます。**Escape** を押して確定してエディターを閉じます。

詳細は [テキストエディター — リッチモード](../../interface/text-editor/#rich-mode) を参照してください。
