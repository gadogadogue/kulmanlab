---
title: Spline Fit — Dibujar Splines Interpoladas por Puntos Clicados
...
| `Enter` / `Space` | Confirmar coordenada escrita (solo Enter), o terminar la spline si no hay entrada en curso y existen ≥ 2 puntos |
