...
description: Il comando Export scarica il disegno corrente come file DXF o JSON (nativo). JSON preserva tutte le entità incluse quote e leader; DXF è compatibile con altri strumenti CAD.
