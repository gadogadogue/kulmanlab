...
| [Hatch](./commands/hatch/) | Preenche a região que envolve um ponto clicado com um padrão |
...
| [Array Grid](./commands/array-grid/) | Repete entidades em uma grade retangular de linhas e colunas |
...
| [LeaderAdd](./commands/leader-add/) | Adiciona um braço extra a um multileader existente |
| [LeaderRemove](./commands/leader-remove/) | Remove um braço de um multileader existente |
...
| Comando | O que faz |
|---------|-----------|
| [LayerManager](./commands/layer-manager/) | Adicione camadas e edite para cada uma o congelamento, o bloqueio, a impressão, a cor, a espessura e o tipo de linha |
