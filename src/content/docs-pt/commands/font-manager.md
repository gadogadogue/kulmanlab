---
title: Font Manager — Enviar e Gerenciar Fontes TTF Personalizadas
...
1. Clique em **Add Font** no rodapé da caixa de diálogo (ou digite [`FontAdd`](../font-add/) no terminal para abrir o seletor de arquivos diretamente).
