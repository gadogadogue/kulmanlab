---
title: "LeaderRemove — Pfeilspitzen-Arm von Mehrfachführungslinie entfernen"
description: "Der Befehl LeaderRemove entfernt einen Pfeilspitzen-Arm von einer Mehrfachführungslinie mit zwei oder mehr Armen. Fahren Sie mit dem Cursor über den zu entfernenden Arm — der nächstgelegene Arm wird hervorgehoben. Knickpunkt, Text und verbleibende Arme bleiben erhalten."
keywords: [CAD Führungslinie Arm entfernen, leaderremove Befehl, Pfeil von Führungslinie entfernen, Mehrfachführungslinie Arm löschen, kulmanlab]
group: markup
order: 3
---
...
| [LeaderAdd](../leader-add/) | Einen Arm zu einer vorhandenen Mehrfachführungslinie hinzufügen |
