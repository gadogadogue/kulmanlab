...
| [Hatch](./commands/hatch/) | Udfyld området omkring et klikket punkt med et mønster |
...
| [Fillet](./commands/fillet/) | Afrund et hjørne mellem to linjer, buer eller polylinjesegmenter med en tangentbue |
...
| Kommando | Hvad den gør |
|---------|-------------|
| [LayerManager](./commands/layer-manager/) | Tilføj lag og redigér for hvert frysning, låsning, plot, farve, tykkelse og linjetype |
...
| [Font+](./commands/font-add/) | Upload en brugerdefineret TTF-skrifttype direkte fra terminalen |
