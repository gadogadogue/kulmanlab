...
description: Lệnh Trim xóa phần của Line, Arc, Circle, Ellipse, Polyline hoặc Spline giữa hai điểm giao nhau liền kề gần con trỏ nhất. Bản xem trước hiển thị chính xác đoạn nào sẽ bị cắt trước khi nhấp.
keywords: [lệnh cắt CAD, cắt đường thẳng CAD, cắt hình tròn CAD, cắt cung CAD, cắt hình elip CAD, cắt đường đa đoạn CAD, cắt spline CAD, cắt tại giao điểm, xem trước hover cắt, kulmanlab]
group: edit
order: 8
---
...
Lệnh `trim` xóa phần của [Line](../line/), [Arc](../arc/), [Circle](../circle/), [Ellipse](../ellipse/), [Polyline](../polyline/) hoặc Spline nằm giữa hai điểm giao nhau liền kề, chia thực thể thành một hoặc nhiều phần còn lại. Đoạn cần cắt được xác định bởi vị trí con trỏ — di chuyển qua phần bạn muốn xóa và nhấp để cắt.
...
| Spline | Tối đa hai thực thể Spline ngắn hơn, được khớp lại từ các điểm lấy mẫu dọc theo đường cong gốc |
...
Các thực thể dùng làm **ranh giới cắt** có thể là Line, Arc, Circle, Ellipse, Polyline hoặc Spline. Các thực thể Văn bản, Kích thước và Đường dẫn không bao giờ ghi nhận giao điểm, nên cũng không thể đóng vai trò ranh giới.
...
| Thực thể được hỗ trợ | Line, Arc, Circle, Ellipse, Polyline, Spline | Chỉ Line |
