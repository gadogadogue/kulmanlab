...
| [Fillet](./commands/fillet/) | ทำมุมโค้งระหว่างสองเส้น ส่วนโค้ง หรือส่วน polyline ด้วยส่วนโค้งสัมผัส |
| [Chamfer](./commands/chamfer/) | ตัดมุมเฉียงตรงระหว่างสองเส้นหรือโพลีไลน์ |
| [Explode](./commands/explode/) | แยกโพลีไลน์ออกเป็นเส้นตรงและส่วนโค้งแต่ละส่วน |
...
| คำสั่ง | สิ่งที่ทำ |
|---------|-----------|
| [LayerManager](./commands/layer-manager/) | เพิ่มเลเยอร์และแก้ไขการซ่อน การล็อก การพล็อต สี ความหนา และชนิดเส้นของแต่ละเลเยอร์ |
...
| [Export Manager](./commands/export-manager/) | ดาวน์โหลดภาพวาดเป็น DXF หรือ JSON |
