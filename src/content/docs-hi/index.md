...
| [Align](./commands/align/) | पॉइंट जोड़ों का उपयोग करके ऑब्जेक्ट ट्रांसलेट, रोटेट और वैकल्पिक रूप से स्केल करें |
...
| [Fillet](./commands/fillet/) | दो रेखाओं, आर्क, या पॉलीलाइन खंडों के बीच कोने को स्पर्शरेखा चाप से गोल बनाएं |
| [Chamfer](./commands/chamfer/) | दो रेखाओं या पॉलीलाइन के बीच सीधा विकर्ण कोना काटें |
| [Explode](./commands/explode/) | पॉलीलाइन को उसकी अलग-अलग लाइन और आर्क में तोड़ता है |
...
| [Export Manager](./commands/export-manager/) | ड्राइंग को DXF या JSON के रूप में डाउनलोड करें |
