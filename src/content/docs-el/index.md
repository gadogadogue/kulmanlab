...
| [Fillet](./commands/fillet/) | Στρογγυλοποιεί γωνία μεταξύ δύο γραμμών, τόξων ή τμημάτων polyline με εφαπτομενικό τόξο |
| [Chamfer](./commands/chamfer/) | Κόβει ευθεία διαγώνια γωνία μεταξύ δύο γραμμών ή polylines |
| [Explode](./commands/explode/) | Διασπά μια πολυγραμμή στις μεμονωμένες γραμμές και τόξα της |
...
| Εντολή | Τι κάνει |
|--------|----------|
| [LayerManager](./commands/layer-manager/) | Προσθέστε επίπεδα και επεξεργαστείτε για καθένα το πάγωμα, το κλείδωμα, την εκτύπωση, το χρώμα, το πάχος και τον τύπο γραμμής |
